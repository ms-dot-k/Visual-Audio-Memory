...
def parse_args():
    ...
    parser.add_argument("--checkpoint_dir", type=str, default='./data/checkpoints/LRW_18_KV')
    parser.add_argument("--checkpoint", type=str, default='/mnt/hard2/Exp/Lip_reading/TMM21/LRW18_ICCV/data/MSTCN_Back_Ckpt.ckpt')
