...
class MultiDataset(Dataset):
    ...
    def build_tensor(self, frames):
        ...
        ### Random Erasing ###
        if self.augmentations:
            x_s, y_s = [random.randint(-20, 66) for _ in range(2)]  # starting point
    ...
    def __getitem__(self, idx):
        ...
        pad_num = (video_duration * info['audio_fps'] - aud_pt_size) // 2
        if pad_num > 0:
        ...
        spec = nn.ConstantPad2d((0, num_v_frames * 4 - num_a_frames, 0, 0), 0.0)(spec)
